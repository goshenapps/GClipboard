...
public class MuseB extends Fragment  {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText(R.string.intro2Title);
        worded.setText(R.string.intro2Text);


        Uri uri = Uri.parse("android.resource://"+ getActivity().getPackageName() + "/"+ R.raw.intro2);
